...
namespace foobar4423.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   $SONG$ - $ARTIST$ via $ALBUM$ - $ALBUM_ARTIST$ / $TRACK_NUMBER$ #nowplaying に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string DefaultNPFormat {
            get {
                return ResourceManager.GetString("DefaultNPFormat", resourceCulture);
            }
        }
    }
}
