...
namespace foobar4423.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   $SONG$&lt; - $ARTIST$&gt;&lt; via $ALBUM$&gt;&lt; - $ALBUM_ARTIST$&gt;&lt; / Track.$TRACK_NUMBER$&gt; &lt; - CD$DISC_NUMBER$&gt; #nowplaying に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Please OAuth authentication and config! に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string Form_InitialMessage {
            get {
                return ResourceManager.GetString("Form_InitialMessage", resourceCulture);
            }
        }
